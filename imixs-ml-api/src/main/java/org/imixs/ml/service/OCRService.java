...
/**
 * The OCRService sends a attachment to a given Tika Service URL and returns the 
 * text data.
 * 
 * 
 * @version 1.0
...
public class OCRService {
     ...
     */
    public byte[] loadFileFromArchive(FileData fileData, String uniqueId, WorkflowClient workflowClient)
            throws RestAPIException {
