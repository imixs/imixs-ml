...
if __name__ == "__main__":
    ...
    TRAIN_DATA = [('what is the price of 11,00', {'entities': [(21, 25, 'iban')]}), 
              ...
              ('what is the price of 10,40', {'entities': [(21, 25, 'iban')]}), 
              ...
              ('what is the price of 1500,00', {'entities': [(21, 27, 'iban')]}), 
              ('what is the price of 70000,00', {'entities': [(21, 28, 'iban')]}), 
              ('what is the price of 30,00', {'entities': [(21, 25, 'iban')]}), 
              ('what is the price of 20,00', {'entities': [(21, 25, 'iban')]}), 
