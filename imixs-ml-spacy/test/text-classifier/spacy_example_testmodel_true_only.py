...
TRAIN_DATA = [('Please see our invoice below.', {'cats': {'invoice': True}}),
              ('Please pay the total amount of our invoice.', {'cats': {'invoice': True}}),
              ('We send you an invoice regarding your 47445', {'cats': {'invoice': True}}),
              
              ('Please send us an offer.', {'cats': {'offer': True}}),
              ...
              ('We order the following parts. ', {'cats': {'order': True}})
             ]
